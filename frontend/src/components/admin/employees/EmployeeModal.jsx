                ...
                <header className="relative flex items-center justify-between px-8 py-5 shrink-0">
                    <div>
                        <h2 className="text-xl font-black text-slate-800 tracking-tight">
                            {employee ? 'Sunting Data' : 'Tambah Baru'}
                        </h2>
                ...
                <form onSubmit={handleSubmit} className="relative flex flex-col max-h-[85vh]">
                    <div className="flex-1 overflow-y-auto px-8 pb-6 space-y-6 scrollbar-hide">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div className="space-y-1.5">
                                    <label className="text-[10px] font-black text-slate-500 uppercase tracking-widest ml-1">Email Karyawan</label>
                                    <div className="relative group">
                                        <div className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-primary transition-colors">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div className="space-y-1.5 text-left">
                                    <label className="text-[10px] font-black text-slate-500 uppercase tracking-widest ml-1">Hak Akses (Role)</label>
                            ...
                            <div className="flex items-center justify-between">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-[9px] font-bold text-indigo-500/80 uppercase tracking-widest mt-0.5">Akses terminal workstation</p>
                                    </div>
                                </div>
                                ...
                                <div className="space-y-3 animate-in slide-in-from-top-4 duration-500">
                                    ...
                                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 py-1">
                                        <div className="space-y-0.5">
                                            ...
                                            <p className="text-[9px] text-slate-400 font-medium">PIN login workstation.</p>
                                        </div>
                                        <input 
                                            type="text"
                                            maxLength={6}
                    ...
                    <div className="px-8 py-5 bg-slate-50/50 border-t border-slate-100 flex gap-4 shrink-0">
                        ...
                        >
                            ...
                            {employee ? 'Simpan' : 'Daftar Karyawan'}
                        </button>
                    </div>
                </form>
            </div>
